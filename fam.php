...
<head>
    ...
    <meta name="author" content="LOKIIPTV">
...
<body>
    <style>
        .jw-svg-icon-pause {
            background-image: url("jwplay/pause.svg");
        }
        ...
        [class~=jw-svg-icon-buffer] {
            background-image: url("jwplay/buffer.svg");
        }
        ...
        [class~=jw-icon-playback]:hover [class~=jw-svg-icon-pause] {
            background-image: url("jwplay/pause-hover.svg");
        }

        [class~=jw-icon-replay]:hover [class~=jw-svg-icon-replay] {
            background-image: url("jwplay/replay-hover.svg");
        }

        [class~=jw-svg-icon-replay] {
            background-image: url("jwplay/replay.svg");
        }

        .jw-svg-icon-rewind {
            background-image: url("jwplay/rewind.svg");
        }
        ...
        [class~=jw-state-paused] [class~=jw-svg-icon-play] {
            background-image: url("jwplay/play.svg");
        }

        .jw-state-paused .jw-icon-playback:hover .jw-svg-icon-play {
            background-image: url("jwplay/play-hover.svg");
        }

        [class~=jw-svg-icon-next] {
            background-image: url("jwplay/next.svg");
        }
        ...
        [class~=jw-icon-rewind]:hover [class~=jw-svg-icon-rewind] {
            background-image: url("jwplay/rewind-hover.svg");
        }

        [class~=jw-icon-next]:hover [class~=jw-svg-icon-next] {
            background-image: url("jwplay/next-hover.svg");
        }

        .jw-svg-icon-volume-100 {
            background-image: url("jwplay/volume-on.svg");
        }
        ...
        .jw-icon-volume:hover .jw-svg-icon-volume-100 {
            background-image: url("jwplay/volume-on-hover.svg");
        }

        [class~=jw-svg-icon-volume-0] {
            background-image: url("jwplay/volume-off.svg");
        }

        [class~=jw-svg-icon-cc-off] {
            background-image: url("jwplay/captions.svg");
        }
        ...
        [class~=jw-icon-volume]:hover [class~=jw-svg-icon-volume-0] {
            background-image: url("jwplay/volume-off-hover.svg");
        }
        ...
        [class~=jw-svg-icon-playlist] {
            background-image: url("jwplay/playlist.svg");
        }
        ...
        [class~=jw-icon-cc-off]:hover [class~=jw-svg-icon-cc-off] {
            background-image: url("jwplay/captions-hover.svg");
        }

        [class~=jw-svg-icon-settings] {
            background-image: url("jwplay/settings.svg");
        }

        [class~=jw-svg-icon-quality-100] {
            background-image: url("jwplay/quality.svg");
        }

        [class~=jw-playlist-btn]:hover [class~=jw-svg-icon-playlist] {
            background-image: url("jwplay/playlist-hover.svg");
        }
        ...
        .jw-svg-icon-close {
            background-image: url("jwplay/close.svg");
        }

        [class~=jw-icon-settings]:hover [class~=jw-svg-icon-settings] {
            background-image: url("jwplay/settings-hover.svg");
        }

        [class~=jw-svg-icon-fullscreen-on] {
            background-image: url("jwplay/fullscreen-on.svg");
        }

        .jw-settings-quality:hover .jw-svg-icon-quality-100 {
            background-image: url("jwplay/quality-hover.svg");
        }

        [class~=jw-settings-close]:hover [class~=jw-svg-icon-close] {
            background-image: url("jwplay/close-hover.svg");
        }
        ...
        [class~=jw-svg-icon-fullscreen-off] {
            background-image: url("jwplay/fullscreen-off.svg");
        }
        ...
        [class~=jw-icon-fullscreen]:hover [class~=jw-svg-icon-fullscreen-on] {
            background-image: url("jwplay/fullscreen-on-hover.svg");
        }
        ...
        [class~=jw-icon-fullscreen]:hover [class~=jw-svg-icon-fullscreen-off] {
            background-image: url("jwplay/fullscreen-off-hover.svg");
        }
